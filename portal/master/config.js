const Config = {
    ...
    alerting: {
        ...
        initialAlerts: {
            "qs-release": {
                ...
                content:
          "Dieses Geoportal dient der Qualitätskontrolle durch den Kunden.<br>Es ist aufgrund von möglichen Fehlern <b>nicht</b> zur Nutzung für alltägliche oder berufliche Aufgaben geeignet!<br><br>",
    ...
    cesiumLibrary:
    "https://geoportal-hamburg.de/mastercode/cesium/latest/Cesium.js",
    portalLanguage: {
        enabled: true,
        debug: false,
        languages: {
