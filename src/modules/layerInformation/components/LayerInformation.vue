...
export default {
  ...
  computed: {
    ...
    ...mapGetters("Modules/Legend", ["layerInfoLegend"]),
...
<template lang="html">
  <div id="modules-layer-information">
    <nav role="navigation">
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a
            href="#layer-info"
            class="nav-link"
            :class="{ active: isActiveTab('layer-info') }"
            @click="setActiveTab"
            >Info</a
          >
        </li>
        ...
        >
          <a
            ...
            @click="setActiveTab"
            >{{ $t("common:modules.layerInformation.legend") }}</a
          >
        </li>
        <li
          v-if="showDownloadLinks && false"
        ...
        >
          <a
            ...
            @click="setActiveTab"
            >{{ $t("common:modules.layerInformation.downloadDataset") }}</a
          >
        </li>
        <li
          v-if="showUrl && false"
    ...
    <div class="tab-content">
      <div
        id="layer-info"
        :class="getTabPaneClasses('layer-info')"
        :show="isActiveTab('layer-info')"
      >
        <div>
          ...
          >
            ...
            <p>{{ contact.street + "  " + contact.postalCode }}</p>
            <p>{{ contact.city }}</p>
          ...
          <p v-if="showPublication">
            {{
              $t("common:modules.layerInformation.publicationCreation") +
              ": " +
              datePublication
            }}
          </p>
      ...
      >
        ...
        >
          <span class="bold">
            {{ $t("common:modules.layerInformation.attachFileMessage") }}
          </span>
        </div>
      </div>
      <div
...
.nav-link {
  ...
  &.active {
    background-color: $amarex_secondary !important;
